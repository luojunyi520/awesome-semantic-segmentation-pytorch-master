...
def get_espnet(dataset='pascal_voc', backbone='resnet50', pretrained=False, root='~/.torch/models',
    ...
    if pretrained:
        ...
        #                       map_location=device))
        model.load_state_dict(torch.load('../models/espnet_resnet50_citys.pth',map_location=device))
    return model
